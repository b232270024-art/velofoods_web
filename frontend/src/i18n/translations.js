...
export const t = {
  en: {
    ...
    menuPlanAddonDesc: "Our picks for you — choose as many as you'd like, then pick which days to receive them.",
    menuPlanAddonReviewLabel: 'Extra',
    menuPlanAddonScheduleBtn: 'Schedule your extras',
    menuPlanAddonConfigureBtn: 'Configure',
    menuPlanAddonScheduleTitle: 'Schedule your extras',
    menuPlanAddonScheduleDone: 'Done',
    menuPlanAddonEmpty: 'No extras selected yet.',
    menuPlanAddonSummaryTitle: 'Your selections',
    addonModeOnce: 'Once',
    addonModeDaily: 'Every day',
    addonModeCustom: 'Specific days',
    addonDeliveredAllDays: 'Delivered every day of your plan',
    ...
    chatGatePlaceholder: 'e.g. 4XK9-P2QW',
    ...
    chatGateOrDivider: 'or',
    chatGateGeneralBtn: 'Chat without an order',
    chatGeneralBackBtn: 'Back',
  ...
  ar: {
    ...
    chatGatePlaceholder: "مثال: 4XK9-P2QW",
    ...
    chatGateOrDivider: "أو",
    chatGateGeneralBtn: "الدردشة بدون طلب",
    chatGeneralBackBtn: "رجوع",
    ...
    menuPlanAddonScheduleBtn: "جدولة الإضافات الخاصة بك",
    menuPlanAddonScheduleTitle: "جدولة الإضافات الخاصة بك",
    menuPlanAddonScheduleDone: "تم الإنتهاء",
    menuPlanAddonEmpty: "لم يتم تحديد أي إضافات بعد.",
    addonModeOnce: "مرة واحدة",
    addonModeDaily: "كل يوم",
    addonModeCustom: "أيام محددة",
    addonDeliveredAllDays: "يتم تسليمها كل يوم من خطتك",
    menuPlanAddonConfigureBtn: "تكوين",
    menuPlanAddonSummaryTitle: "اختياراتك ",
  },
  ...
  hi: {
    ...
    chatGatePlaceholder: "उदा. 4XK9-P2QW",
    ...
    chatGateOrDivider: "या",
    chatGateGeneralBtn: "बिना ऑर्डर के चैट करें",
    chatGeneralBackBtn: "वापस",
    ...
    menuPlanAddonScheduleBtn: "अपने अतिरिक्त सामान शेड्यूल करें",
    menuPlanAddonScheduleTitle: "अपने अतिरिक्त सामान शेड्यूल करें",
    menuPlanAddonScheduleDone: "हो गया",
    menuPlanAddonEmpty: "अभी तक कोई अतिरिक्त नहीं चुना गया है।",
    addonModeOnce: "एक बार",
    addonModeDaily: "हर दिन",
    addonModeCustom: "विशिष्ट दिन",
    addonDeliveredAllDays: "आपकी योजना के हर दिन डिलीवर किया जाता है",
    menuPlanAddonConfigureBtn: "कंफिगर करें",
    menuPlanAddonSummaryTitle: "आपके चयन",
  },
};
